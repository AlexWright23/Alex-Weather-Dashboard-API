...
var prevCity = document.getElementById("lastCity")
...
function displayForecast(forcastData) {
  ...
  for (var i = 0; i < 5; i++) {
      ...
      forecastContainer.className = `col bg-primary text-white ml-3 md-3 rounded forecast cardShadow`;
      forecastContainer.setAttribute("style", "width: 170px;", "height: 100px;")
